# Registers the xquery language in Komodo.

import logging
from koUDLLanguageBase import KoUDLLanguage

log = logging.getLogger("koxqueryLanguage")
#log.setLevel(logging.DEBUG)

def registerLanguage(registry):
    log.debug("Registering language xquery")
    registry.registerLanguage(KoxqueryLanguage())

class KoxqueryLanguage(KoUDLLanguage):

    # ------------ Komodo Registration Information ------------ #

    name = "xquery"
    lexresLangName = "xquery"
    ...
    #           'M': 'XML',             #   XML
    #        }
    lang_from_udl_family = {'SSL': 'xquery'}
